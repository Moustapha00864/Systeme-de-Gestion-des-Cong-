...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Employés | Afficher la liste vos demandes</title>
...
.succWrap{
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Discuter avec la Direction</div>
                    </div>
    ...
    <aside>
                <p class="sidebar-chat-name">Moustapha Ndiaye<a href="#" data-activates="chat-messages" class="chat-message-link"><i class="material-icons">keyboard_arrow_right</i></a></p>
