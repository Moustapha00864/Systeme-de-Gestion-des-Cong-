...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>JOKALANTE | Mise a Jour des modifications</title>
                        ...
                        <div class="card">
                            <div class="card-content">
                                <form id="example-form" method="post" name="updatemp">
                                    <div>
                                        <h3>Interface de Mise a jour des Informations de contacts des Employés </h3>
                                           <?php if($error){?><div class="errorWrap"><strong>Erreur  veuillez reéssayer</strong>:<?php echo htmlentities($error); ?> </div><?php } 
                else if($msg){?><div class="succWrap"><strong>Les modification ont eté enregistré avec succées</strong> : <?php echo htmlentities($msg); ?> </div><?php }?>
                                        <section>
...
<label for="empcode">Code Employé</label>
