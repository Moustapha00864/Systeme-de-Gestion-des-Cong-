...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>JOKALANTE | Demande Non Aprouvé </title>
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"> Listes des Demandes Non Aprouvés</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Listes des Demandes Non Aprouvés</span>
