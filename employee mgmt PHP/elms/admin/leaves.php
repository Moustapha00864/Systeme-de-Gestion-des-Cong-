...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>JOKALANTE | Totals Demandes </title>
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Listes des demandes</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Listes des demandes</span>
