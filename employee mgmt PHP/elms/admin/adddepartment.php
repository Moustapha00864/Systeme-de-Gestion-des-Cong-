...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>JOKALANTE | Ajout Department</title>
  ...
  <?php include('includes/header.php');?>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Ajout Department</div>
                    </div>
