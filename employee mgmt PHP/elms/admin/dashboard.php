...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>JOKALANTE | Tableau de Bord</title>
                    ...
                    <div class="col s12 m12 l4">
                        <div class="card stats-card">
                            <div class="card-content">
                                ...
                                <span class="card-title">Total de Employés Inscrits</span>
...
?>
                        ...
                        <div class="card stats-card">
                            <div class="card-content">
                                ...
                                <span class="card-title">Total de Departments </span>
    <?php
...
?>                           
                    ...
                    <div class="col s12 m12 l4">
                        <div class="card stats-card">
                            <div class="card-content">
                                <span class="card-title">Total des Demandes</span>
                                    <?php
                        ...
                        <div class="col s12 m12 l12">
                            <div class="card invoices-card">
                                <div class="card-content">
                                    ...
                                    <span class="card-title">Tableau Recaputilatif des Demandes d'Autorisations</span>
                             <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th width="200">Nom Employé</th>
                                            <th width="120">Type de Demande</th>
