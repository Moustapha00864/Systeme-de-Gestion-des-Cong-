...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>JOKALANTE | Ajouter des  Employés</title>
...
<label for="empcode">Code Employé(Doit etre unique)</label>
...
<div class="input-field col s12">
<label for="confirm">Veuiller confirmer le Mot de Pass</label>
